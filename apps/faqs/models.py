...
class FAQ(BaseFAQ):
    ...
    question = models.CharField(max_length=2000, help_text='')
    answer = RichTextField(null=True, blank=True, help_text='')
    related_node = models.ForeignKey(Node, blank=True, null=True, related_name='faqs_faq_node', editable=False)
