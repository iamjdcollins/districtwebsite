...
from apps.documents.models import Document, BoardPolicy, Policy, AdministrativeProcedure, SupportingDocument, BoardMeetingAgenda, BoardMeetingMinutes, BoardMeetingAudio, BoardMeetingVideo
...
class BoardMeetingAdmin(MPTTModelAdmin,GuardedModelAdmin):
    ...
    inlines = [BoardMeetingAgendaInline,BoardMeetingMinutesInline,BoardMeetingAudioInline,BoardMeetingVideoInline]
