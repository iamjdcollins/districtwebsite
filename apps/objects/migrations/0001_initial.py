    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_node', models.OneToOneField(db_column='user_node', editable=False, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='objects.Node')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('directoryentry_node', models.OneToOneField(db_column='directoryentry_node', editable=False, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='objects.Node')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Document',
            fields=[
                ('document_type', models.CharField(blank=True, editable=False, max_length=200, null=True)),
                ('document_node', models.OneToOneField(db_column='document_node', editable=False, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='objects.Node')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='File',
            fields=[
                ('file_type', models.CharField(blank=True, editable=False, max_length=200, null=True)),
                ('file_node', models.OneToOneField(db_column='file_node', editable=False, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='objects.Node')),
            ],
            options={
                'verbose_name': 'File',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_node', models.OneToOneField(db_column='image_node', editable=False, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='objects.Node')),
            ],
            options={
                'verbose_name': 'Image',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_node', models.OneToOneField(db_column='page_node', editable=False, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='objects.Node')),
            ],
            options={
                'verbose_name': 'Page',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taxonomy_node', models.OneToOneField(db_column='taxonomy_node', editable=False, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='objects.Node')),
            ],
            options={
