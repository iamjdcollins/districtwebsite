...
CKEDITOR.plugins.add( 'departments', {
	...
	init: function( editor ) {
		...
		editor.addCommand( 'insertDepartment', {

			// Define the function that will be fired when the command is executed.
			exec: function( editor ) {
				// Insert the timestamp into the document.
				editor.insertHtml( '<a class="relink" data-id="91da9da2-d3ed-4f8b-a765-6c20ec093d4d">Payroll</a>' );
			}
		});
