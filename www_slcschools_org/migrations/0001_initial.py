...
def default_domain(apps, schema_editor):
    ...
    site, created = Site.objects.get_or_create(
        domain='www.slcschools.org',
        defaults={'name': 'District Website'},
    )
    site.save()
    alias, created = Alias.objects.get_or_create(domain='www.slcschools.org',is_canonical=True,redirect_to_canonical=False,site=site)
    alias.save()
